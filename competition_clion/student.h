...
private:
    ...
    string reg_courses[2];             // The course selected by the FUS for the student to take
...
public:
    ...
    void schedule(string a, string b);                              // Method that schedules the selected courses of the student to the morning of afternoon class slot for the student. see student.cpp line 49 for the method's body
    string attendance();
