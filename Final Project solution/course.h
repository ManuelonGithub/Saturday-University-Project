...
public:
    course(string cID, bool scheduled = false);    // Class course constructor. See course.cpp line 9 for the constructor's body
    void set_pre_req(string id );                     // Method that adds a course ID to the pre-requisite vector that each course contains. See course.cpp line 15 for the Method's body
    ...
    void schedule(char t);                                // Method that schedules the course to its designated time slot. See course.cpp line 50 for the Method's body
