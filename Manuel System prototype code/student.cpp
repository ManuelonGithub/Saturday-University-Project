...
void student::write(ostream &out) const     // Method that prints pertinent student information to out
{
    ...
    out << setw(42) << "Course Selected for the term: " << selected_course << "\n";
...
string student :: bestChoice(vector<course> &available)     // Method that determines the selected course that the student should take
{
	int preReqDone;
